...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT30SSHingMoreSecurely/TTT_30_SSHing_More_Securely.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also {url-mp3}/TTT30SSHingMoreSecurely/TTT_30_SSHing_More_Securely.mp3[download the MP3]
****
...
====
In later versions of OSX (macOS), you may not get the popup offering to save your passphrase to Apple Keychain. In that case follow the instructions in this Stack Exchange post: https://apple.stackexchange.com/questions/48502/how-can-i-permanently-add-my-ssh-private-key-to-keychain-so-it-is-automatically[apple.stackexchange.com/...]
====

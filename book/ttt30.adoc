...
====
In later versions of OSX (macOS), you will not get the popup offering to save your passphrase to Apple Keychain. See Chapter 37 under "SSH Agent on OS X & macOS" for the new method.
====

...
ifndef::backend-pdf[]
+++<audio controls='1' src="https://media.blubrry.com/tamingtheterminal/archive.org/download/TTT13PATH/TTT_13_PATH.mp3">+++Your browser does not support HTML 5 audio 🙁+++</audio>+++
endif::[]

Scan the QRcode to listen on a different device

image::./assets/qrcodes/TTT_13.png[QRcode, align='left']

You can
ifndef::backend-pdf[also]
https://media.blubrry.com/tamingtheterminal/archive.org/download/TTT13PATH/TTT_13_PATH.mp3?autoplay=0&loop=0&controls=1[download the MP3]
****
...
NOTE: *Aside:* in the last instalment we used a Bash shell script for our example, this time, for some variety, I'm using a Perl script, the language used has no bearing on how all this works.
...
For reasons we won't go into now, if you're a Linux user the user-level file to create/edit is `~/.bashrc`, while Mac users should create/edit `~/.bash_profile` (if you really care about why there is a difference you can have a read of https://www.joshstaiger.org/archives/2005/07/bash_profile_vs.html[this short article]).

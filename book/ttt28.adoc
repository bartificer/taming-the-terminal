...
[source,console?prompt=bart$,linenums,highlight='1']
----
...
[source,console?prompt=bart$,linenums,highlight='1,15']
----
...
[source,console?prompt=bart$,linenums,hightlight='1,15']
----
...
[source,console?prompt=bart$,linenums,highlight='1,3,4']
----
...
[source,console?prompt=bart$,linenums,highlight='1,2']
----

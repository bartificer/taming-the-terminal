...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT15Plumbing/TTT_15_Plumbing.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT15Plumbing/TTT_15_Plumbing.mp3[download the MP3]

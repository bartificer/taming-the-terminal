...
Right back in the very xref:ttt01[first instalment], we described the Unix philosophy as being Lego-like,
...
image::qrcodes/TTT_15.png[QR code, align='left']
...
We can overcome the first of these limitations by using the `head` command we met in xref:ttt11[part 11 of this series].

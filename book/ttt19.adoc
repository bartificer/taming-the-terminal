...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT19TextSearches/TTT_19_Text_Searches.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT19TextSearches/TTT_19_Text_Searches.mp3[download the MP3]

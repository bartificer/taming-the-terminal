...
pass:m,a[<audio controls='controls' src="https://media.blubrry.com/tamingtheterminal/archive.org/download/ttt-38-tmux/TTT_38_TMUX.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also
https://media.blubrry.com/tamingtheterminal/archive.org/download/ttt-38-tmux/TTT_38_TMUX.mp3[play/download the MP3 in your browser]
****

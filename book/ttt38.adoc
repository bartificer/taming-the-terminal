...
Listen along to this instalment on https://www.podfeet.com/blog/2020/07/ccatp-645/[episode 583 of the Chit Chat Across the Pond Podcast]
...
You can issue commands for controlling your tmux session from within your tmux session by first pressing `ctrl+b` to enter _command mode_, and then entering your desired command.

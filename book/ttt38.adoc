...
part of  https://www.podfeet.com/blog/2020/07/ccatp-645/[episode 583 of the Chit Chat Across the Pond Podcast]

// no audiocontrols in pdf
ifndef::backend-pdf[]
pass:m,a[<audio controls='controls' src="https://media.blubrry.com/nosillacast/traffic.libsyn.com/nosillacast/CCATP_2020_07_11.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also
https://media.blubrry.com/nosillacast/traffic.libsyn.com/nosillacast/CCATP_2020_07_11.mp3[download the MP3]
****
...
*You can (re)name a session any time from within the session by pressing* kbd:[cmd+b] *followed by* kbd:[$]*.*

Practice by re-naming the first session to `ttt` by pressing kbd:[cmd+b], then kbd:[$], then back-space to delete the existing name (`0`), and finally typing `ttt` and pressing enter.

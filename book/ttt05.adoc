...
pass:m,a[<audio controls='1' src="{url-mp3}/TTT05FilePermissions/TTT_05_File_Permissions.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT05FilePermissions/TTT_05_File_Permissions.mp3?autoplay=0&loop=0&controls=1[download the MP3]
****

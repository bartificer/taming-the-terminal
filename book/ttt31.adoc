...
As an example, let's use `rsync` to backup the contents of the remote folder `/tmp/ttt31/rsync_folder` to the local folder `/tmp/ttt31/fromRemote/rsync_backup`.

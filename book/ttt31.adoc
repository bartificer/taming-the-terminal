...
You can also {url-mp3}/TTT31SSHFileTransfers/TTT_31_SSH_File_Transfers.mp3[download the MP3]
...
We're not going to describe all the optional flags `scp` supports. You can read about those in the man age for `scp`.

...
In <<ttt29.adoc#ttt29,Part 29 of n>> we learned how to use SSH to execute commands on a remote computer.
In <<ttt30.adoc#ttt30,the previous instalment>> we learned how to add security and convenience to SSH connections using SSH key-pairs.

...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT12TheEnvironment/TTT_12_The_Environment.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT12TheEnvironment/TTT_12_The_Environment.mp3[download the MP3]

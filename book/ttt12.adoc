...
pass:m,a[<audio controls='1' src="{url-mp3}/TTT12TheEnvironment/TTT_12_The_Environment.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT12TheEnvironment/TTT_12_The_Environment.mp3?autoplay=0&loop=0&controls=1[download the MP3]
...
=== Environment Variables and subshells -- OPTIONAL
...
[NOTE]
====
*Aside:* The first line of this script is called the "`shebang line`", and it tells Bash what interpreter it should use to run the file.

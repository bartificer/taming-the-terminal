...
This is the second instalment of an ongoing series.
In xref:ttt01[the first instalment], I tried to give you a sort of 40,000-foot view of command shells -- some context, some history, a very general description of what command shells do, and a little bit on why they are still very useful in the modern GUI age.
...
image::qrcodes/TTT_02.png[QR code, align='left']

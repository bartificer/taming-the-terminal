...
So far we've learned how to <<ttt29.adoc#ttt29,securely execute terminal commands on remote computers>>, how to <<ttt31.adoc#ttt31,securely copy files across the network using SSH>>, how to <<ttt30.adoc#ttt30,add both security and convenience>> to both those operations with SSH key pairs, and how to <<ttt32.adoc#ttt32,tunnel just about anything through SSH>>.

...
pass:m,a[<audio controls='1' src="{url-mp3}/TTT25aIPSubnets/TTT_25a_IP_Subnets.mp3">Your browser does not support HTML 5 audio</audio>]


pass:m,a[<audio controls='1' src="{url-mp3}/TTT25bIPSubnets/TTT_25b_IP_Subnets.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]

Scan the QRcode to listen on a different device

image::qrcodes/TTT_25a.png[QRcode, align='left']

image::qrcodes/TTT_25b.png[QRcode, align='left']

You can
ifndef::backend-pdf[also]
{url-mp3}/TTT25aIPSubnets/TTT_25a_IP_Subnets.mp3?autoplay=0&loop=0&controls=1[download the MP3 (1)]

You can
ifndef::backend-pdf[also]
{url-mp3}/TTT25bIPSubnets/TTT_25b_IP_Subnets.mp3?autoplay=0&loop=0&controls=1[download the MP3 (2)]
****

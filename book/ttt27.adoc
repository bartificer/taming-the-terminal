...
We have now looked in detail at xref:ttt24[Layer 1] and xref:ttt25[Layer 2], and have looked at how xref:ttt26[DHCP] allows our computers to automatically configure their TCP/IP network stack.
...
a|image::qrcodes/TTT_27a.png[QR code 27a]
a|image::qrcodes/TTT_27b.png[QR code 27b]

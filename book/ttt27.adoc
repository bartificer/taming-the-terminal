...
|pass:m,a[<audio controls='controls' src="{url-mp3}/TTT27aDNS/TTT_27a_DNS.mp3">Your browser does not support HTML 5 audio</audio>]
|pass:m,a[<audio controls='controls' src="{url-mp3}/TTT27bDNS/TTT_27b_DNS.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
|You can also {url-mp3}/TTT27aDNS/TTT_27a_DNS.mp3[download the MP3 (a)]
|You can also {url-mp3}/TTT27bDNS/TTT_27b_DNS.mp3[download the MP3 (b)]
|===
...
ifdef::backend-html[pass:[<!-- vale Vale.Repetition = NO -->]]
...
ifdef::backend-html[pass:[<!-- vale Vale.Repetition = YES -->]]
...
[source,shell,linenums,highlight='1,3']
----
...
[source,shell,linenums,highlight='1,20']
----
...
[source,shell,linenums,highlight='1,4,10']
----
...
[source,shell,linenums,highlight='1,18,22,38']
----

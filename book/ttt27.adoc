...
We have now looked in detail at <<ttt24.adoc#ttt24,Layer 1>> and <<ttt25.adoc#ttt25,Layer 2>>, and have looked at how <<ttt26.adoc#ttt26,DHCP>> allows our computers to automatically configure their TCP/IP network stack.

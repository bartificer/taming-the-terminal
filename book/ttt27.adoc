...
We have now looked in detail at <<ttt24.adoc,Layer 1>> and <<ttt25.adoc,Layer 2>>, and have looked at how <<ttt26.adoc,DHCP>> allows our computers to automatically configure their TCP/IP network stack.

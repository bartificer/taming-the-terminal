...
[source,console?prompt=bart$,linenums,highlight='1,20']
----
...
[source,console?prompt=bart$,linenums,highlight='1,4,10']
----
...
[source,console?prompt=bart$,linenums,highlight='1,18,22,38']
----

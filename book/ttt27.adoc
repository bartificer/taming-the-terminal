...
pass:m,a[<audio controls='1' src="{url-mp3}/TTT27aDNS/TTT_27a_DNS.mp3">Your browser does not support HTML 5 audio</audio>]


pass:m,a[<audio controls='1' src="{url-mp3}/TTT27bDNS/TTT_27b_DNS.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
======
[.left]
image::./assets/qrcodes/TTT_27a.png[QRcode MP3 (1)]

image::./assets/qrcodes/TTT_27b.png[QRcode MP3 (2)]
======
...
{url-mp3}/TTT27aDNS/TTT_27a_DNS.mp3?autoplay=0&loop=0&controls=1[download the MP3 (1)]

You can
ifndef::backend-pdf[also]
{url-mp3}/TTT27bDNS/TTT_27b_DNS.mp3?autoplay=0&loop=0&controls=1[download the MP3 (2)]

...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT18aMoreREs/TTT_18a_More_REs.mp3">Your browser does not support HTML 5 audio</audio>]


pass:m,a[<audio controls='controls' src="{url-mp3}/TTT18bMoreREs/TTT_18b_More_REs.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT18aMoreREs/TTT_18a_More_REs.mp3[download the MP3 (1)]

You can
ifndef::backend-pdf[also]
{url-mp3}/TTT18bMoreREs/TTT_18b_More_REs.mp3[download the MP3 (2)]
****

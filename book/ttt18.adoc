...
pass:m,a[<audio controls='1' src="{url-mp3}/TTT18aMoreREs/TTT_18a_More_REs.mp3">Your browser does not support HTML 5 audio</audio>]


pass:m,a[<audio controls='1' src="{url-mp3}/TTT18bMoreREs/TTT_18b_More_REs.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]

Scan the QRcode to listen on a different device

image::qrcodes/TTT_18a.png[QRcode, align='left']

image::qrcodes/TTT_18b.png[QRcode, align='left']



You can
ifndef::backend-pdf[also]
{url-mp3}/TTT18aMoreREs/TTT_18a_More_REs.mp3?autoplay=0&loop=0&controls=1[download the MP3 (1)]

You can
ifndef::backend-pdf[also]
{url-mp3}/TTT18bMoreREs/TTT_18b_More_REs.mp3?autoplay=0&loop=0&controls=1[download the MP3 (2)]
****

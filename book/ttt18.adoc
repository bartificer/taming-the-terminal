...
In xref:ttt17[the previous instalment], we introduced the concept of Regular Expressions and started to learn the POSIX ERE regular expression language, noting that POSIX ERE is a sub-set of the very commonly used Perl Compatible Regular Expression (PCRE) language.
...
a|image::qrcodes/TTT_18a.png[QR code 18a]
a|image::qrcodes/TTT_18b.png[QR code 18b]

[[ttt24]]
= TTT Part 24of 1 {longdash} Ethernet & ARP
...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT24EthernetAndARP/TTT_24_Ethernet_and_ARP.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also {url-mp3}/TTT24EthernetAndARP/TTT_24_Ethernet_and_ARP.mp3[download the MP3]

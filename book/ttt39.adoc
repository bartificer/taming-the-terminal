...
ifndef::backend-pdf[]
pass:m,a[<audio controls='controls' src="https://media.blubrry.com/tamingtheterminal/archive.org/download/ttt-39-advanced-tmux/TTT_39_Advanced_TMUX.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also
https://media.blubrry.com/tamingtheterminal/archive.org/download/ttt-39-advanced-tmux/TTT_39_Advanced_TMUX.mp3[download the MP3]
****

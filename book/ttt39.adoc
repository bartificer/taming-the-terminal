...
part of  https://www.podfeet.com/blog/2020/07/ccatp-647/[episode 583 of the Chit Chat Across the Pond Podcast]

// no audiocontrols in pdf
ifndef::backend-pdf[]
pass:m,a[<audio controls='controls' src="https://media.blubrry.com/nosillacast/traffic.libsyn.com/nosillacast/CCATP_2020_07_25.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also
https://media.blubrry.com/nosillacast/traffic.libsyn.com/nosillacast/CCATP_2020_07_25.mp3[download the MP3]
****
...
Why would TMUX dedicate valuable status-bar space to an indicate for the last viewed window? Simple -- because *you can jump directly to that window by entering command mode with kbd:[ctrl+b] and hitting kbd:[l]* (lower-case L for _last_).
...
You can `move between panes is by pressing kbd:[ctrl+b] to enter command mode and then pressing an arrow key`. Additionally *you can cycle through your panes by entering command mode with kbd:[ctrl+b] and pressing kbd:[o] to move to the next pane in the sequence*.

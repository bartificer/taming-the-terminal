...
ifndef::backend-pdf[]
pass:m,a[<audio controls='1' src="https://media.blubrry.com/tamingtheterminal/archive.org/download/ttt-36-screen-and-cron_202004/TTT_36_screen_and_cron.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
https://media.blubrry.com/tamingtheterminal/archive.org/download/ttt-36-screen-and-cron_202004/TTT_36_screen_and_cron.mp3?autoplay=0&loop=0&controls=1[download the MP3]

...
ifndef::backend-pdf[]
pass:m,a[<audio controls='1' src="https://media.blubrry.com/nosillacast/traffic.libsyn.com/nosillacast/CCATP_2016_11_19.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]

Scan the QRcode to listen on a different device

image::qrcodes/CCATP_2016.png[QRcode, align='left']

...
In <<ttt29.adoc,the previous instalment>> we saw how we can use SSH to execute a single command on a remote computer, or, to get a command shell on a remote computer.

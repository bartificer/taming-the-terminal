...
Since we covered SSH in parts <<ttt29.adoc,29>> & <<ttt30.adoc,30>>, Apple have changed how their desktop OS deals with the passphrases protecting SSH identities (key pairs).

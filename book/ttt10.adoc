...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT10Man/TTT_10_man.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT10Man/TTT_10_man.mp3[download the MP3]
****

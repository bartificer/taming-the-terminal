...
pass:m,a[<audio controls='1' src="{url-mp3}/TTT01CommandShells/TTT_01_Command_Shells.mp3">Your browser does not support HTML 5 audio</audio>]
...
image::./assets/qrcodes/TTT_01.png[QRcode, align='left']

You can
ifndef::backend-pdf[also]
{url-mp3}/TTT01CommandShells/TTT_01_Command_Shells.mp3?autoplay=0&loop=0&controls=1[download the MP3]
****

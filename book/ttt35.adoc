[[ttt35]]
= TTT Part 35of 1 {longdash} HTTP Commands
...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT35HTTPCommands/TTT_35_HTTP_Commands.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also {url-mp3}/TTT35HTTPCommands/TTT_35_HTTP_Commands.mp3[download the MP3]
...
[source,shell,linenums,highlight='2,5']
----

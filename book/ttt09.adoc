...
In the xref:ttt08[previous instalment], we looked at how Unix-like operating systems such as Linux and Mac OS X represent processes.
...
image::qrcodes/TTT_09.png[QR code, align='left']

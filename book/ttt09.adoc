...
In the <<ttt08,previous instalment>> we looked how Unix-like operating systems like Linux and Mac OS X represent processes.
...
,
or selecting _Quit_ form an app's menu.

...
In xref:ttt13[the previous instalment], we looked at how to make permanent changes to our environment.
...
image::qrcodes/TTT_14.png[QR code, align='left']
...
On the RedHat and CentOS variants of Linux the default is `[\u@\h \W]\$`, which give prompts that look like:

...
The least-generous description of this could be that SSH has become a kind of sysadmins https://www.urbandictionary.com/define.php?term=fridgeoven[fridgeoven].
...
ifndef::backend-pdf[]
+++<audio controls='1' src="https://media.blubrry.com/tamingtheterminal/archive.org/download/TTT29IntroToSSH/TTT_29_Intro_to_SSH.mp3">+++Your browser does not support HTML 5 audio 🙁+++</audio>+++
endif::[]

Scan the QRcode to listen on a different device

image::./assets/qrcodes/TTT_29.png[QRcode, align='left']

You can
ifndef::backend-pdf[also]
https://media.blubrry.com/tamingtheterminal/archive.org/download/TTT29IntroToSSH/TTT_29_Intro_to_SSH.mp3?autoplay=0&loop=0&controls=1[download the MP3]

...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT29IntroToSSH/TTT_29_Intro_to_SSH.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT29IntroToSSH/TTT_29_Intro_to_SSH.mp3[download the MP3]

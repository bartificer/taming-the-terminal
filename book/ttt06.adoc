...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT06MoreFilePermissions/TTT_06_More_File_Permissions.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
{url-mp3}/TTT06MoreFilePermissions/TTT_06_More_File_Permissions.mp3[download the MP3]
****

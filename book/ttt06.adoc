...
pass:m,a[<audio controls='1' src="{url-mp3}/TTT06MoreFilePermissions/TTT_06_More_File_Permissions.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]

Scan the QRcode to listen on a different device

image::./assets/qrcodes/TTT_06.png[QRcode, align='left']

You can
ifndef::backend-pdf[also]
{url-mp3}/TTT06MoreFilePermissions/TTT_06_More_File_Permissions.mp3?autoplay=0&loop=0&controls=1[download the MP3]
****

...
In xref:ttt05[the previous instalment] of this series, we had a look at how standard Unix File Permissions worked.
...
image::qrcodes/TTT_06.png[QR code, align='left']

...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT17RegularExpressions/TTT_17_Regular_Expressions.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also {url-mp3}/TTT17RegularExpressions/TTT_17_Regular_Expressions.mp3[download the MP3]

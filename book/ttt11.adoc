...
pass:m,a[<audio controls='controls' src="{url-mp3}/TTT11TextFiles/TTT_11_Text_Files.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]
...
You can also {url-mp3}/TTT11TextFiles/TTT_11_Text_Files.mp3[download the MP3]

...
You can also http://media.blubrry.com/tamingtheterminal/archive.org/download/TTT11TextFiles/TTT_11_Text_Files.mp3?autoplay=0&loop=0&controls=1[Download the MP3]
...
All the commands we learned in <<ttt10.adoc#ttt10,the previous instalment>> for navigating around man pages are actually commands for navigation around text files with `less`!

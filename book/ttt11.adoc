...
image::qrcodes/TTT_11.png[QR code, align='left']
...
All the commands we learned in xref:ttt10[the previous instalment] for navigating around man pages are actually commands for navigation around text files with `less`!

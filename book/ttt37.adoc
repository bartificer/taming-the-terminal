...
Since we covered SSH in parts xref:ttt29[29] & xref:ttt30[30], Apple has changed how their desktop OS deals with the passphrases protecting SSH identities (key pairs).
...
****
[none]
* xref:Revision_SSH_Identities[1 Revision -- SSH Identities]
* xref:SSH_Agents[2 SSH Agents]
[none]
** xref:It8217s_All_About_the_ssh-add_Command[2.1 It's All About the ssh-add Command]
** xref:Loading_Identities_into_an_SSH_Agent[2.2 Loading Identities into an SSH Agent]
** xref:Removing_Identities_from_an_SSH_Agent[2.3 Removing Identities from an SSH Agent]
* xref:SSH_Agent_on_macOS[3 SSH Agent on OS X & macOS]
[none]
* xref:Final_Thoughts[4 Final Thoughts]
****
...
image::qrcodes/TTT_37.png[QR code, align='left']
...
image::qrcodes/TTT_37A.png[QR code, align='left']

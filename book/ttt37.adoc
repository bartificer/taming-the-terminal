...
ifndef::backend-pdf[]
pass:m,a[<audio controls='1' src="https://media.blubrry.com/nosillacast/traffic.libsyn.com/nosillacast/CCATP_2017_05_26.mp3">Your browser does not support HTML 5 audio</audio>]
endif::[]

Scan the QRcode to listen on a different device

image::./assets/qrcodes/CCATP_2017.png[QRcode, align='left']

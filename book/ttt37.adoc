...
[NOTE]
====
This instalmemt was originally written, and its matching podcast episode recorded in May 2017. The Mac-specific aspects of this instalment were updated in February 2021, and an additional supplemental podcast was recorded and has been linked below.
====
...
// no audiocontrols in pdf
ifndef::backend-pdf,apple-books[]
audio::{url-mp3}/ttt-37-ssh-agents_202004/TTT_37A_SSH_Agents.mp3[]
endif::[]
...
You can also
{url-mp3}/ttt-37A-ssh-agents_202102/TTT_37_SSH_Agents.mp3[play/download the MP3 in your browser]
****

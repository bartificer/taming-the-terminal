...
Since we covered SSH in parts <<ttt29.adoc#ttt29,29>> & <<ttt30.adoc#ttt30,30>>, Apple have changed how their desktop OS deals with the passphrases protecting SSH identities (key pairs).
